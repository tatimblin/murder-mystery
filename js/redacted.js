...
allQuestions[10] = {
    question: "Why was this person resentful towards Robert?",
    choices: ['“Robert’s affair with an employee”', '“Robert’s ruthless business decisions”', "An underappreciated work ethic”],
    correctAnswer: 2
};
allQuestions[11] = {
    question: "Who was resentful towards Robert?",
...
allQuestions[16] = {
    question: "Who can be removed from the suspect list? ",
    choices:['“William”', '“Theodore”', '“Alice”', "Ethan” ],
    correctAnswer: 1
};
allQuestions[17] = {
    question: "Who can be removed from the suspect list? ",
    choices:['“Theodore”', '“William”', "Ethan”, “Alice” ],
    correctAnswer: 0

};
allQuestions[18] = {
    question: "Who received access to the chemical just days before the murder? ",
    choices:['“William”', '“Alice”', "Ethan”,  “Theodore”, “Simon”],
    correctAnswer: 2
